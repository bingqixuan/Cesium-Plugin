...
(function () {
    ...
    CoorTrans.prototype.fromScreenToCartesian3 = function(screenX, screenY) {
        ...
        if(this._viewer.scene.mode === 3){
            ...
            return this._viewer.camera.pickEllipsoid(pick, viewer.scene.globe.ellipsoid);
        }
    };
    ...
    /**
     * 墨卡托坐标转WGS84
     * @param {Cartesian3} cartesian 墨卡托坐标，单位米，例如new Cesium.Cartesian3(x,y,0)
